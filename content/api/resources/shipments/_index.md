...
| sender_tax_identification_numbers | array of [tax-identification-numbers](/api/resources/common-objects/tax-identification-numbers) | Tax ID numbers of the sender. Any numbers passed on the shipment will overwrite numbers of the same `type` and `country_code` defined on the organization of this shipment's shop during registration. |
